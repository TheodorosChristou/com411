print ("Print enter the first number") #Asks for first number
n1 = int(input())
print ("Print enter the second number") #Asks for second number
n2 = int(input())
print ("Print enter the third number") #Asks for third number
n3 = int(input())
